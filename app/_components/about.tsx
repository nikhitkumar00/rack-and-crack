...
const About = () => {
  return (
    <div className="flex flex-col gap-4 px-6 pb-12 pt-8 text-right font-secondary text-secondary sm:px-12 sm:pt-12 md:pb-16 lg:px-16 lg:pb-24 xl:px-32 2xl:px-48">
